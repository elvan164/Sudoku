...
public class Sudoku2 extends JFrame implements KeyListener {
	...
	private void themeMenu() {
		...
		ActionListener themeListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				...
				colorIniText = new Color(redRand, greenRand, blueRand);
				...
				greenRand = (int) (Math.random() * 255 + 1);
				blueRand = (int) (Math.random() * 255 + 1);
				colorSetText = new Color(redRand, greenRand, blueRand);

				redRand = (int) (Math.random() * 255 + 1);
				greenRand = (int) (Math.random() * 255 + 1);
				blueRand = (int) (Math.random() * 255 + 1);
				colorConflictBack = new Color(redRand, greenRand, blueRand);

				themeChange();
			}
		};

		themeTime = new Timer(500, themeListener);
